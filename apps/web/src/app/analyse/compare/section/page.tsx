  ...
  return (
    <div className="min-h-screen bg-[#0b1220] text-[#e2e8f0]">
      ...
      <div className="h-[46vh] w-full relative">
        ...
        <Link href={src ? `/analyse/${src}` : '/analyse/library'} className="absolute top-3 right-3 z-[1000] bg-[#0f172a]/95 border border-[#1e293b] rounded px-3 py-2 text-[10px] tracking-widest text-[#94a3b8] hover:text-[#e2e8f0]">← BACK</Link>
      </div>
